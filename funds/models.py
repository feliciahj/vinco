...
class Fund(models.Model):
    ...
    y_2015 = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    y_2014 = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    y_2013 = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    y_2012 = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    y_2011 = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    y_2010 = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
    y_2009 = models.DecimalField(max_digits=5, decimal_places=4, null=True, blank=True)
